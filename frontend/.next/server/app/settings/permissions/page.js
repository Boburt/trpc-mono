...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63723)), "/root/projects/trpc-mono/frontend/app/settings/permissions/page.tsx"],
...
const pages = ["/root/projects/trpc-mono/frontend/app/settings/permissions/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/settings/permissions/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 17079))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ PermissionListPage)
});
...
;// CONCATENATED MODULE: ./store/api/permission.ts

function usePermissionsQuery(filter) {
    return trpc/* trpc */.S.permissions.list.useQuery(filter);
}
function usePermissionsCreate(options) {
    const utils = trpc/* trpc */.S.useContext();
    return trpc/* trpc */.S.permissions.add.useMutation({
        ...options,
        onSuccess: (post)=>{
...
function usePermissionsUpdate(options) {
    const utils = trpc/* trpc */.S.useContext();
    return trpc/* trpc */.S.permissions.renew.useMutation({
        ...options,
        onSuccess: (post)=>{
            utils.permissions.list.invalidate();
            options?.onSuccess?.(post);
...
function usePermissionsDestroy(options) {
    const utils = trpc/* trpc */.S.useContext();
    return trpc/* trpc */.S.permissions.delete.useMutation({
        ...options,
        onSuccess: (post)=>{
            utils.permissions.list.invalidate();
            options?.onSuccess?.(post);
...
;// CONCATENATED MODULE: ./app/settings/permissions/data-table.tsx
...
;// CONCATENATED MODULE: ./app/settings/permissions/form.tsx
...
function PermissionsForm({ children, recordId }) {
    const { toast } = (0,use_toast/* useToast */.pm)();
    const [open, setOpen] = (0,react_.useState)(false);
    const form = (0,index_esm/* useForm */.cI)({
        resolver: (0,zod/* zodResolver */.F)(lib_zod/* permissionsCreateInputSchema */.Jzu),
        defaultValues: {
            active: true,
            slug: "",
            description: ""
    ...
    const { mutateAsync: createPermission, isLoading: isAddLoading, data, error } = usePermissionsCreate({
        onSuccess: ()=>onAddSuccess("added"),
        onError
    });
    const { mutateAsync: updatePermission, isLoading: isUpdateLoading, error: updateError } = usePermissionsUpdate({
        onSuccess: ()=>onAddSuccess("updated"),
        onError
    });
    const { data: record, isLoading: isRecordLoading } = trpc/* trpc */.S.permissions.one.useQuery({
        where: {
            id: recordId
        }
    }, {
...
;// CONCATENATED MODULE: ./app/settings/permissions/delete-action.tsx
...
;// CONCATENATED MODULE: ./app/settings/permissions/columns.tsx
/* __next_internal_client_entry_do_not_use__ permissionsColumns auto */ 
    ...
    },
    {
        ...
        cell: ({ row })=>{
            ...
            return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex items-center space-x-2",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(PermissionsForm, {
                        recordId: record.id,
...
;// CONCATENATED MODULE: ./app/settings/permissions/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "flex items-center space-x-2",
                        children: /*#__PURE__*/ jsx_runtime_.jsx(PermissionsForm, {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/root/projects/trpc-mono/frontend/app/settings/permissions/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [654,365,687,815,3,245,607], () => (__webpack_exec__(55298)));
