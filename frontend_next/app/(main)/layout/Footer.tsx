...
import FooterCatalogMenu from "./FooterCatalogMenu";

export default function Footer() {
  return (
    <footer className="w-full py-10 px-4 sm:px-6 lg:px-8 bg-content4 dark:bg-slate-950">
      <div className="container mx-auto mt-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
          <div className="col-span-full hidden lg:col-span-1 lg:block">
            ...
            <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-content4-foreground">
          ...
          <div className="sm:flex sm:justify-between sm:items-center">
            ...
            <div className="flex justify-between items-center">
              <div className="mt-3 sm:hidden">
                ...
                <p className="mt-1 text-xs sm:text-sm text-gray-600 dark:text-content4-foreground">
                  © 2022 Preline.
                </p>
              </div>
