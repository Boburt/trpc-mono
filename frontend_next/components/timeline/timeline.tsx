...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "absolute translate-x-36 md:-translate-x-24 text-sm font-semibold leading-none text-content-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-semibold leading-none tracking-tight text-content-foreground",
      className
    )}
    {...props}
  >
